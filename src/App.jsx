    ...
    <div className="App">
      <header className={styles.Header}>
        <div className={styles.Header_main}>
          <nav>
            <ul>
              <li className={styles.nav_recall}><a href="/">Главная</a></li>
              <li className={styles.nav_recall}><a href="/">Оклейка автомобилей</a></li>
              <li className={styles.nav_recall}><a href="/">Детейлинг автомобилей</a></li>
              <li className={styles.nav_recall}><a href="/">Галерея работ</a></li>
            </ul>
            <button>
